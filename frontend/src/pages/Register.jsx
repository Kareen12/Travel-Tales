...
const Register = () => {
  ...
  return (
    ...
    <h1 className="text-lg md:text-xl font-extrabold bg-lime-200 p-3 rounded-full"><Link to="/">Travel Tales</Link></h1>
    <h3 className="bg-lime-200 hover:bg-transparent p-3 rounded-full"><Link to="/login">Login</Link></h3>
    </div>
    <div className="w-full flex justify-center items-center h-[80vh] ">
       <div className="flex flex-col justify-center items-center space-y-4 w-[80%] md:w-[25%]">
         ...
         <button onClick={handleRegister} className="w-full px-4 py-4 text-lg font-bold text-white bg-black rounded-lg hover:bg-lime-200 hover:text-black">Register</button>
